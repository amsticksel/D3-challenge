...
function xScale(smokingData, chosenXAxis) {
    // create scales
    var xLinearScale = d3.scaleLinear()
        .domain([d3.min(smokingData, d => d[chosenXAxis]) * 0.8,
        d3.max(smokingData, d => d[chosenXAxis]) * 1.2
        ])
        .range([0, width]);
...
d3.csv("./assets/data/data.csv").then(function (smokingData, err) {
    ...
    // parse data
    smokingData.forEach(function (data) {
    ...
    var xLinearScale = xScale(smokingData, chosenXAxis);

    // Create y scale function
    var yLinearScale = d3.scaleLinear()
        .domain([0, (d3.max(smokingData, d => d.obesity)+20)])
        .range([height, 0]);
